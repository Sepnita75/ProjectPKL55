...
public class LoginButton extends JLabel{
    ...
    public LoginButton() {
        setText("");
        setIcon(new ImageIcon(getClass().getResource("/pkl55/gui/images/loginbutton.png")));
        addMouseListener(new MouseListener() {
            ...
            public void mousePressed(MouseEvent me) {
                setIcon(new ImageIcon(getClass().getResource("/pkl55/gui/images/loginbutton_clicked.png")));
            }
            ...
            public void mouseReleased(MouseEvent me) {
                if(((getLocationOnScreen().x<MouseInfo.getPointerInfo().getLocation().x)&&((getLocationOnScreen().x+getWidth())>MouseInfo.getPointerInfo().getLocation().x))&&((getLocationOnScreen().y<MouseInfo.getPointerInfo().getLocation().y)&&((getLocationOnScreen().y+getHeight())>MouseInfo.getPointerInfo().getLocation().y))){
                    setIcon(new ImageIcon(getClass().getResource("/pkl55/gui/images/loginbutton_hover.png")));
                }
                click.click();
            }
