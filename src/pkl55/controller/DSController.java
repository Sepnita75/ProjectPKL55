...
public class DSController {
    ...
    private EntryKuesPanel entryKuesPanel;
    private DSSubPanel dSSubPanel;
    private LoginPanelController loginPanelController;

    public DSController(final LoginPanelController loginPanelController, EntryKuesPanel entryDSPanel, DSSubPanel dSSubPanel) {
        this.entryKuesPanel = entryDSPanel;
